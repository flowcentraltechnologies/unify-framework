 ...
 * @since 4.1
 */
public abstract class AbstractPlainOutputStreamController extends AbstractPlainController {
    ...
    protected abstract void prepareExecution(ClientRequest request) throws UnifyException;
