 ...
 * @since 4.1
 */
@StaticList(name = "processingstatuslist", description = "$m{staticlist.processingstatuslist}")
public enum ProcessingStatus implements EnumConst {
    ...
    public static ProcessingStatus fromCode(String code) {
        return EnumUtils.fromCode(ProcessingStatus.class, code);
    }

    public static ProcessingStatus fromName(String name) {
        return EnumUtils.fromName(ProcessingStatus.class, name);
    }
