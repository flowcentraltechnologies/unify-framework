...
/**
 * SQL dialect list command.
 * 
 * @author The Code Department
 * @since 4.1
 */
@Component("sqldialectlist")
public class SQLDialectListCommand extends AbstractZeroParamsListCommand {

    @Override
    public List<? extends Listable> execute(Locale locale, ZeroParams param) throws UnifyException {
        return SqlUtils.getSQLDialects();
    }
