...
/**
 * Enumeration field condition list command.
 * 
 * @author The Code Department
 * @since 4.1
 */
@Component("enumfieldconditionlist")
public class EnumFieldConditionListCommand extends AbstractZeroParamsListCommand {
        ...
        protected List<Listable> create(Locale locale, Object... arg1) throws Exception {
            List<Listable> list = new ArrayList<Listable>();
                for (FilterConditionType condType : FilterUtils.getSupportedFilterConditionTypes(String.class,
                        FilterConditionListType.IMMEDIATE_ENUM_FIELD)) {
