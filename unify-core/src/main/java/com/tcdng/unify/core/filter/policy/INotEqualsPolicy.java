...
/**
 * Not equal (case-sensitive) policy.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class INotEqualsPolicy extends AbstractSingleParamObjectFilterPolicy {

    public INotEqualsPolicy() {
        super(true);
    }
    ...
    protected boolean doMatch(Object fieldVal, Object param) throws UnifyException {
        return fieldVal != null && param != null
                && !(((String) fieldVal).toLowerCase().equals(((String) param).toLowerCase()));
    }
