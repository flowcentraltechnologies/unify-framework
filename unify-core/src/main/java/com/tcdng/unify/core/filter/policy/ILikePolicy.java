...
/**
 * Case-insensitive like policy.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class ILikePolicy extends AbstractSingleParamObjectFilterPolicy {
    ...
    protected boolean doMatch(Object fieldVal, Object param) throws UnifyException {
        return fieldVal != null && param != null
                && ((String) fieldVal).toLowerCase().contains(((String) param).toLowerCase());
    }
