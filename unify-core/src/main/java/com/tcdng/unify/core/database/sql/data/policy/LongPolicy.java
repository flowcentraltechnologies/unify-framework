...
/**
 * Long data type SQL policy.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class LongPolicy extends AbstractSqlDataTypePolicy {
    ...
    public void executeRegisterOutParameter(Object cstmt, int index) throws Exception {
        ((CallableStatement) cstmt).registerOutParameter(index, Types.BIGINT);
    }

    @Override
    public Object executeGetOutput(Object cstmt, Class<?> type, int index, long utcOffset) throws Exception {
        Object object = ((CallableStatement) cstmt).getLong(index);
