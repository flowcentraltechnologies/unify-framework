...
public class AreaChart extends AbstractChart {
    ...
    private AreaChart(int width, int height, ColorPalette colorPalette, ChartImageFormat format,
    ...
    private AreaChart(int width, int height, ColorPalette colorPalette, AnnotationType annotationType,
    ...
    public static class Builder {
        ...
        public AreaChart build() {
            if (format == null) {
                return new AreaChart(width, height, colorPalette, annotationType, valueFormat, showLegend,
                        DataUtils.unmodifiableList(seriesList), showXAxisTicks, showYAxisTicks);
            }

            return new AreaChart(width, height, colorPalette, format, annotationType, valueFormat, showLegend,
                    DataUtils.unmodifiableList(seriesList), showXAxisTicks, showYAxisTicks);
        }
    }
