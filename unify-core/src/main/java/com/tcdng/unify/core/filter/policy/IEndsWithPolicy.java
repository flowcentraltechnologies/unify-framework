...
/**
 * Case-insensitive ends with policy.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class IEndsWithPolicy extends AbstractSingleParamObjectFilterPolicy {

    public IEndsWithPolicy() {
        super(false);
    }

    @Override
    protected boolean doMatch(Object fieldVal, Object param) throws UnifyException {
        return fieldVal != null && param != null
                && ((String) fieldVal).toLowerCase().endsWith(((String) param).toLowerCase());
    }
