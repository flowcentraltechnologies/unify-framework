...
public interface SqlDataSourceDialect extends DataSourceDialect, SqlGenerator {
	...
	String TRUNC_COLUMN_ALIAS = "tca1";
	 ...
	 * 
	 * @param nativeVal  the native value
	 ...
	 * 
	 * @param restrictionType the operator
	 * @throws UnifyException if an error occurs
	 */
	 ...
	 * 
	 * @param record       the record to update
	 * @param oldVersionNo the old version number
	 ...
	 * 
	 * @param query  the criteria object
	 * @param update the update information
	 * @return the update by query statement.
	 * @throws UnifyException if an error occurs
	 */
	 ...
	 * 
	 * @param callableProc the callable procedure object
	...
	/**
	 * Returns the reporting name for dialect.
	 * 
	 * @param name the name
	 */
	String getReportingName(String name);
	 ...
	 * statement info pool.
	 * 
	 * @param sqlStatement the statement info to restore
	 * @throws UnifyException if an error occurs
	 */
	 ...
	 * 
	 * @param sqlCallableStatement the statement info to restore
	 * @throws UnifyException if an error occurs
	 */
