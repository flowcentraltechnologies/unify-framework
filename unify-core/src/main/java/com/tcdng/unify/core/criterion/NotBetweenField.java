...
/**
 * Restriction for a property not between two fields.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class NotBetweenField extends AbstractDoubleParamRestriction {

    public NotBetweenField(String propertyName, String fieldNameA, String fieldNameB) {
