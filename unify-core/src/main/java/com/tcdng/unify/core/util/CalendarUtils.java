...
public final class CalendarUtils {
	 ...
	 * 
	 * @param weekdays the calendar week days. Can be null
	 * @param days     the calendar days. Can be null
	 * @param months   the calendar months. Can be null
	...
	/**
	 * Returns the first day of month date for a specified date.
	 * 
	...
	/**
	 * Returns the last day of month date for a specified date.
	 * 
	 * @param date the supplied date
	 */
	 ...
	 * @throws UnifyException if a parse error occurs
	 */
	 ...
	 * @throws UnifyException if supplied unit is invalid
	 * @see FrequencyUnit
	 */
	 ...
	 * 
	 * @param timeInMilliSecs the duration in milliseconds
	 * @return a date difference object that represents the total difference i days,
	 *         hours, minutes and seconds
	 */
