...
/**
 * Collection size greater or equal policy.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class GreaterOrEqualCollectionPolicy extends AbstractCollectionSizeObjectFilterPolicy {

    public GreaterOrEqualCollectionPolicy() {
        super(false);
    }
