 ...
 * @since 4.1
 */
@Component(name = SqlDialectNameConstants.MARIADB, description = "$m{sqldialect.mariadb}")
public class MariaDbDialect extends AbstractSqlDataSourceDialect {

	private static final MariaDbDataSourceDialectPolicies sqlDataSourceDialectPolicies = new MariaDbDataSourceDialectPolicies();
	...
	static {
		...
		tempMap1.put(ColumnType.BLOB, new MariaDbBlobPolicy());
		tempMap1.put(ColumnType.CLOB, new MariaDbClobPolicy());
	...
	private static class MariaDbDataSourceDialectPolicies extends AbstractSqlDataSourceDialectPolicies {
...
class MariaDbBlobPolicy extends BlobPolicy {
...
class MariaDbClobPolicy extends ClobPolicy {
