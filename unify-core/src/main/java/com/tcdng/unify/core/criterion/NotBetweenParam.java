...
/**
 * Restriction for a property not between two parameters.
 * 
 * @author The Code Department
 * @since 4.1
 */
public class NotBetweenParam extends AbstractDoubleParamRestriction {

    public NotBetweenParam(String propertyName, String paramNameA, String paramNameB) {
