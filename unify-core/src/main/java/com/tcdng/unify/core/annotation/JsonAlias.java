...
/**
 * Annotation JSON alias attributes of a field.
 * 
...
public @interface JsonAlias {
	...
	/**
	 * Alias format.
	 * @return standard format type
	 */
	StandardFormatType format() default StandardFormatType.NONE; 
}
