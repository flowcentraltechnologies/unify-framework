...
import com.tcdng.unify.web.ui.widget.control.DebitCreditLabel;
...
public class DebitCreditLabelWriter extends AbstractControlWriter {

    @Override
    protected void doWriteStructureAndContent(ResponseWriter writer, Widget widget) throws UnifyException {
        DebitCreditLabel label = (DebitCreditLabel) widget;
        writer.write("<span");
