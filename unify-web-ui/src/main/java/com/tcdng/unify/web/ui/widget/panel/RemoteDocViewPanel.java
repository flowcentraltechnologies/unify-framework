...
/**
 * Represents a remote document view panel.
 * 
 * @author The Code Department
 * @version 1.0
 */
@Component("ui-remotedocviewpanel")
@UplAttributes({ @UplAttribute(name = "hideOnNoComponents", type = boolean.class, defaultVal = "false") })
