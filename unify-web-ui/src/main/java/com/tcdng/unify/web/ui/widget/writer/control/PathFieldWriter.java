...
import com.tcdng.unify.web.ui.widget.control.PathField;
 ...
 * @since 4.1
 */
@Writes(PathField.class)
@Component("pathfield-writer")
public class PathFieldWriter extends TextFieldWriter {

    @Override
    protected String getFormatRegex(TextField textField) throws UnifyException {
        return WebRegexUtils.getPathFormatRegex();
    }
}
