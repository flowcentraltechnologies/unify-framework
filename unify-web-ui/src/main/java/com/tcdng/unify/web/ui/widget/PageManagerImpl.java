...
public class PageManagerImpl extends AbstractUnifyComponent implements PageManager {
	...
	public PageManagerImpl() {
		...
		this.standalonePanelInfoByNameMap = new LocaleFactoryMaps<String, StandalonePanelInfo>() {
			...
			private void setEventHandlerPageActions(EventHandler eventHandler, String longName,
					Map<String, PageAction> reusablePageActions) throws UnifyException {
				...
				if (uer != null) {
					...
					for (String actionLongName : uer.getLongNames()) {
						...
						if (pageAction == null) {
							throw new UnifyException(UnifyWebUIErrorConstants.EVENTHANDLER_REFERENCING_UNKNOWN_ACTION,
