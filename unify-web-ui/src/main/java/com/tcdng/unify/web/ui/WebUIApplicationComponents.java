...
/**
 * Web UI application component names.
 * 
 * @author The Code Department
 * @since 4.1
 */
public interface WebUIApplicationComponents {

    String APPLICATION_LISTCONTROLUTIL = "application-listcontrolutil";

    String APPLICATION_PAGEMANAGER = "application-pagemanager";

    String APPLICATION_PAGEPATHINFOREPOSITORY = "application-pagepathinforepository";
    ...
    String APPLICATION_PAGEREQUESTCONTEXTUTIL = "application-pagerequestcontextutil";

    String APPLICATION_UICONTROLLERUTIL = "application-uicontrollerutil";
