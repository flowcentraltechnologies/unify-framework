 ...
 * @since 4.1
 */
@Component("ui-textoptions")
@UplAttributes({
    @UplAttribute(name = "alias", type = String.class, mandatory = true) })
public class TextOptions extends AbstractListControl {
    ...
    public String getAlias() throws UnifyException {
        return getUplAttribute(String.class, "alias");
    }
