 ...
 * @since 4.1
 */
@Component("ui-colorlegend")
@UplAttributes({@UplAttribute(name = "columns", type = int.class, defaultVal = "1")})
public class ColorLegend extends AbstractControl {

	public ColorLegendInfo getColorLegendInfo() throws UnifyException {
		return getValue(ColorLegendInfo.class);
	}
