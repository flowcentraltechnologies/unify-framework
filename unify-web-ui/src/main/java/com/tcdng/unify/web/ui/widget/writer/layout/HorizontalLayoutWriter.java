...
/**
 * Horizontal layout writer.
 * 
 * @author The Code Department
 * @since 4.1
 */
@Writes(HorizontalLayout.class)
@Component("horizontallayout-writer")
public class HorizontalLayoutWriter extends AbstractTabularLayoutWriter {
